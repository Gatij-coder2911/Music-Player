...
class CTkListbox(customtkinter.CTkScrollableFrame):
    ...
    def __init__(self,
        ...
        # Configure the column to make buttons expand
    ...
    def insert(self, index, option, **args):
        ...
        self.buttons[index].grid(padx=0, pady=(0,5), column=0, sticky='nsew', columnspan=2)
        # print("Row from inside file : ",self.buttons[index].grid_info()['row'])
